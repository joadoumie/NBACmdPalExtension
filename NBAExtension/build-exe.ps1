...
foreach ($Platform in $Platforms) {
    ...
    Write-Host "Output directory: $ProjectDir\bin\$Configuration\win-$Platform\publish" -ForegroundColor Cyan
...
if (Test-Path $InnoSetupPath) {
        ...
        if ($LASTEXITCODE -eq 0) {
            Write-Host "Installer output directory: $ProjectDir\bin\$Configuration\installer" -ForegroundColor Cyan
